#' Global VAR Database (1979Q2-2013Q3)
#'
#' The data set of Mohaddes and Raissi (2024) contains economic time series for
#' 33 countries and 3 commodities from 1979Q2 to 2023Q3.
#' 
#' @usage data("gvar2023")
#' 
#' @format A named list containing the following elements:
#' \describe{
#'   \item{\strong{submodel_data}}{A named list of 33 elements, consisting of
#'   submodel-specific data. Each element of those sub-elements includes an
#'   element \strong{endogen}, which is a time-series object with 178 quarterly
#'   observations from 1979Q2 to 2023Q3 of the following variables:
#'   
#'   \itemize{
...
#'}
#'    The second sub-element contains a time-series object containing annual data on
#'   trade flows from 1980 to 2016 for the respective country.
#'   }
#'   \item{\strong{global_data}}{A time-series object containing 178 quarterly observations
#'   from 1979Q2 to 2023Q3 of the following variables
#'   \itemize{
...
#'   from 1990 to 2018 for the countries listed above.}
#' }
#' 
#' @details The variables in \code{submodel_data/endogen} were constructed as
#'   \itemize{
...
#' 
#' See Mohaddes and Raissi (2024) for further details on the sources and compilation of the data set.
#' 
#' @references
#' 
#' Mohaddes, K., & Raissi, M. (2024). \emph{Compilation, revision and updating of the global VAR (GVAR) database, 1979Q2--2023Q3} (mimeo). University of Cambridge: Judge Business School.
...
#'
#' The data set of Mohaddes and Raissi (2020) contains economic time series for
#' 33 countries and 3 commodities from 1979Q2 to 2019Q4.
#' 
#' @usage data("gvar2019")
#' 
#' @format A named list containing the following elements:
...
#'   \item{\strong{submodel_data}}{A named list of 33 elements, consisting of
#'   submodel-specific data. Each element of those sub-elements includes an
#'   element \strong{endogen}, which is a time-series object with 163 quarterly
#'   observations from 1979Q2 to 2019Q4 of the following variables:
#'   
#'   \itemize{
#'   \item \strong{y:} log real GDP
#'   \item \strong{Dp:} rate of inflation
...
#'    trade flows from 1980 to 2016 for the respective country.
#'   }
#'   \item{\strong{global_data}}{A time-series object containing 163 quarterly observations
#'   from 1979Q2 to 2019Q4 of the following variables
#'   \itemize{
#'   \item \strong{poil:} log of oil prices
#'   \item \strong{pmat:} log of agricultural raw material prices
#'   \item \strong{pmetal:} log of metals prices
...
#' @references
#' 
#' Mohaddes, K., & Raissi, M. (2020). \emph{Compilation, revision and updating of the global VAR (GVAR) database, 1979Q2--2019Q4} (mimeo). University of Cambridge: Judge Business School.
#' The paper and dataset can be downloaded from \href{https://www.mohaddes.org/gvar}{https://www.mohaddes.org/gvar}.
#' 
"gvar2019"
...
#' @format A named list containing the following elements:
#' \describe{
#'   \item{\strong{submodel_data}}{A named list of 26 elements, consisting of
#'   submodel-specific data. Each element of those sub-elements includes an
#'   element \strong{endogen}, which is a time-series object with 99 quarterly
#'   observations from 1979Q2 to 2003Q7 of the following variables:
#'   
#'   \itemize{
#'   \item \strong{y:} log real GDP
