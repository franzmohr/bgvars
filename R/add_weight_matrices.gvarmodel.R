...
#' 
#' @param object an object of class 'gvarmodel'. Usually, the output of a call
#' to \code{\link{create_gvarmodel}}.
...
#' 
#' @export
add_weight_matrices.gvarmodel <- function(object, submodel_data, period){
